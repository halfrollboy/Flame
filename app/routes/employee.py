...
async def list_employees(skip: int = 0, max: int = 10, employees: EmployeeRepository = Depends()):
...
async def store_employee(employee: EmployeeCreate, employees: EmployeeRepository = Depends()):
